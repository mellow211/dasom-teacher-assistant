...
const GUIDES: Record<string, Guide> = {
  ...
  "lesson-plans": { title: "1학년 국어 지도안 생성기 사용법", summary: "참고자료의 설계 원리에 따라 목표·학생 수행·평가가 연결된 실제 수업 흐름을 제안합니다.", steps: ["학기·단원·차시 주제와 성취기준 원문을 입력합니다.", "수업 유형을 선택하거나 자동 선택하고 필요한 자료·학급 특성을 덧붙입니다.", "교사 발문과 학생 반응의 대응, 시간 합계, 상·중·하 평가 기준을 확인합니다."] },
  ...
  "leveled-korean-worksheets": { title: "1학년 국어 수준별 활동지 사용법", summary: "같은 학습 목표를 도움과 사고 수준이 다른 활동지 A·B·C로 만듭니다.", steps: ["학습 목표·핵심 내용과 국어 영역을 선택합니다.", "생성 수준·문제 수·인쇄 구성을 설정합니다.", "문항과 정답을 확인·수정한 뒤 학생용 또는 교사용으로 인쇄합니다."] },
  "korean-performance-assessments": { title: "1학년 국어 수행평가 생성기 사용법", summary: "성취기준과 평가 요소를 실제 과제·채점기준·관찰표로 연결합니다.", steps: ["성취기준은 원문 그대로, 평가 요소는 줄마다 최대 3개 입력합니다.", "평가 방법·시간·성취수준과 필요한 경우 배점을 설정합니다.", "학생용과 교사용 자료를 검토·수정한 뒤 필요한 묶음만 인쇄합니다."] },
