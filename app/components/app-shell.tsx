...
const toolRoutes: Record<string, string> = {
  ...
  "지도안 생성기": "/lesson-plans", "수준별 활동지 생성기": "/leveled-korean-worksheets", "글쓰기 피드백": "/writing-feedback", "교과서 받아쓰기 생성기": "/textbook-dictation", "곱셈 퀴즈": "/multiplication-quiz",
