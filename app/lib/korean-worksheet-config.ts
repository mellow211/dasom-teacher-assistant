...
export const KOREAN_WORKSHEET_AREAS = ["한글 자모 익히기", "글자와 소리 연결하기", "낱말 읽기", "낱말 쓰기", "문장 읽기", "문장 쓰기", "어휘 익히기", "글의 내용 확인하기", "인물과 사건 파악하기", "순서에 맞게 내용 정리하기", "생각이나 느낌 표현하기", "바른 말과 고운 말 사용하기", "듣기·말하기 활동", "기타"] as const;
...
export type KoreanWorksheetArea = (typeof KOREAN_WORKSHEET_AREAS)[number];
